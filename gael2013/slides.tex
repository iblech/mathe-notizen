...
\frame[t]{\frametitle{What is a topos?}
  \begin{baddefinition}A \hil{topos} is a category which has finite limits,
  ...
  \begin{examples}\vspace{-0.5em}\begin{itemize}
...
\frame[t]{\frametitle{The petit Zariski topos}
  \begin{definition}The \hil{petit Zariski topos} of a scheme~$X$ is the
...
\frame[t]{\frametitle{The gros Zariski topos}
  \begin{definition}The \hil{gros Zariski topos $\Zar(S)$} of a scheme~$S$ is the
  category $\Sh(\Sch/S)$,
