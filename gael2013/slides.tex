...
\frame[t]{\frametitle{What is the internal language?}
  ...
  \begin{enumerate}
    \item formulate properties,
    \item prove statements and
    \item construct objects and morphisms
  \end{enumerate}
  of the topos by using a \hil{naive element-based} language:
  ...
  \hil{Special case:} The internal language of~$\Set$ is the usual mathematical
  language.
...
\subsection{Open and closed immersions}
\frame[t]{\frametitle{Open and closed immersions}
